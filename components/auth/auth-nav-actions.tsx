      ...
      <div ref={ref} className="relative hidden sm:block">
        ...
        {open && (
          <ul className="absolute right-0 top-full z-30 mt-3 w-48 overflow-hidden rounded-md border border-white/10 bg-graphite shadow-xl">
            ...
            <li>
              <Link href={`${base}/progresso`} onClick={() => setOpen(false)} className="block px-4 py-2.5 text-sm text-white hover:bg-white/5">
                {dict.progress.title}
              </Link>
            </li>
            <li>
              <Link href={`${base}/desafios`} onClick={() => setOpen(false)} className="block px-4 py-2.5 text-sm text-white hover:bg-white/5">
                {dict.challenges.navLabel}
              </Link>
            </li>
            <li>
