...
export default function CoachProfilePage({ params }: { params: { locale: string } }) {
    ...
    <RequireAuth locale={locale}>
      <main className="min-h-screen bg-carbon px-6 pb-24 pt-28">
        ...
        <div className="mx-auto max-w-lg pb-8 text-center">
          <h1 className="font-heading text-2xl font-bold">{dict.coach.profile.title}</h1>
        </div>
        <CoachProfileForm dict={dict} />
      </main>
    </RequireAuth>
  );
}
