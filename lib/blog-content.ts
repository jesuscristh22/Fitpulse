...
const SEED_POSTS: Record<"pt-br" | "en" | "es", BlogPost[]> = {
  "pt-br": [
    ...
    },
    {
      ...
      title: "O que comer antes de treinar pra ter energia de verdade",
      excerpt: "A refeição pré-treino certa evita aquela sensação de corpo pesado ou de fraqueza no meio do exercício.",
      body: [
        "Uma refeição com carboidrato de fácil digestão 1 a 3 horas antes do treino costuma dar energia sem pesar no estômago — coisas como banana, aveia com fruta, ou uma torrada com pasta de amendoim funcionam bem pra maioria das pessoas.",
        "Treinar em jejum total não é errado pra todo mundo, mas quem sente tontura, fraqueza ou desempenho pior sem comer antes provavelmente se beneficia de um lanche leve, mesmo que pequeno.",
        "Comidas muito gordurosas ou muito ricas em fibra pouco antes do treino tendem a causar desconforto digestivo durante o exercício — vale testar em treinos menos importantes antes de repetir num dia que importa.",
        "No fim, o que funciona varia de pessoa pra pessoa — preste atenção em como seu corpo responde e ajuste o horário e a quantidade a partir disso, em vez de seguir uma regra fixa.",
      ],
      tags: ["nutrição", "pré-treino"],
      publishedAt: "2026-06-23",
      source: "seed",
    },
    {
      slug: "como-ler-rotulo-nutricional",
      title: "Como ler um rótulo nutricional pensando nos seus objetivos de treino",
      excerpt: "O rótulo tem mais informação útil do que parece — só precisa saber onde olhar.",
      body: [
        "A tabela nutricional mostra valores por porção, não pelo pacote inteiro — vale conferir o tamanho da porção primeiro, porque é fácil subestimar quanto realmente se está comendo quando o pacote tem várias porções.",
        "Pra quem treina regularmente, prestar atenção em proteína e fibra ajuda tanto na recuperação muscular quanto na saciedade ao longo do dia — nem todo alimento processado deixa isso claro em destaque, então vale olhar a tabela, não só a embalagem.",
        "A lista de ingredientes é ordenada por quantidade, do maior pro menor — se açúcar ou algum tipo de óleo aparece nos primeiros lugares, isso diz mais sobre o alimento do que qualquer selo de \"saudável\" na frente da embalagem.",
        "Isso não precisa virar uma auditoria de cada refeição — usar esse olhar principalmente nos alimentos que você compra com mais frequência já faz diferença com o tempo.",
      ],
      tags: ["nutrição", "hábitos alimentares"],
      publishedAt: "2026-06-16",
      source: "seed",
    },
    {
      slug: "lanches-proteicos-para-dia-corrido",
      title: "Lanches práticos e proteicos pra dia corrido",
      excerpt: "Ter uma opção pronta evita cair no primeiro salgadinho da máquina quando a fome bate.",
      body: [
        "Ovos cozidos, iogurte natural com fruta, ou uma mão cheia de castanhas são opções que não precisam de preparo no momento e cabem numa bolsa ou geladeira do trabalho.",
        "Combinar uma fonte de proteína com uma de carboidrato — como queijo com fruta, ou hummus com cenoura — costuma segurar mais a fome do que só um dos dois isolado.",
        "Preparar 2 ou 3 porções no fim de semana (ovos cozidos, potes de iogurte com granola separado) reduz a chance de ficar sem opção boa durante a semana corrida.",
        "Não existe um lanche perfeito universal — o melhor é o que você realmente vai preparar e comer de novo, então vale começar simples antes de tentar algo elaborado demais pra manter na rotina.",
      ],
      tags: ["nutrição", "praticidade"],
  ...
  en: [
    ...
    {
      slug: "what-to-eat-before-training",
      title: "What to eat before training to actually have energy",
      excerpt: "The right pre-workout meal avoids that heavy or weak feeling mid-exercise.",
      body: [
        "An easy-to-digest carb meal 1 to 3 hours before training tends to give energy without weighing on the stomach — things like a banana, oats with fruit, or toast with peanut butter work well for most people.",
        "Training fully fasted isn't wrong for everyone, but anyone who feels dizzy, weak, or notices worse performance without eating beforehand likely benefits from a light snack, even a small one.",
        "Very fatty or very high-fiber foods right before training tend to cause digestive discomfort during exercise — worth testing on lower-stakes sessions before repeating on a day that matters.",
        "In the end, what works varies person to person — pay attention to how your body responds and adjust timing and amount from there, rather than following a fixed rule.",
      ],
    ...
    },
    {
      ...
      title: "How to read a nutrition label with your training goals in mind",
      excerpt: "The label has more useful info than it looks — you just need to know where to look.",
      body: [
        "The nutrition table shows values per serving, not per package — worth checking the serving size first, since it's easy to underestimate how much you're actually eating when a package has several servings.",
        "For anyone training regularly, paying attention to protein and fiber helps both with muscle recovery and staying full throughout the day — not every processed food makes this obvious up front, so it's worth checking the table, not just the packaging.",
        "The ingredient list is ordered by quantity, highest to lowest — if sugar or some type of oil shows up near the top, that says more about the food than any \"healthy\" label on the front of the package.",
        "This doesn't need to become an audit of every meal — using this lens mainly on the foods you buy most often already makes a difference over time.",
      ],
      tags: ["nutrition", "eating habits"],
      publishedAt: "2026-06-16",
      source: "seed",
    },
    {
      slug: "high-protein-snacks-for-busy-days",
      title: "Practical, high-protein snacks for a busy day",
      excerpt: "Having something ready avoids grabbing the first vending machine snack when hunger hits.",
      body: [
        "Boiled eggs, plain yogurt with fruit, or a handful of nuts are options that need no prep in the moment and fit in a bag or work fridge.",
        "Pairing a protein source with a carb source — like cheese with fruit, or hummus with carrots — tends to hold off hunger better than either one alone.",
        "Prepping 2 or 3 servings on the weekend (boiled eggs, yogurt cups with granola set aside) reduces the odds of being stuck without a good option during a busy week.",
        "There's no universal perfect snack — the best one is whatever you'll actually prep and eat again, so it's worth starting simple before trying something too elaborate to keep up with.",
      ],
      tags: ["nutrition", "convenience"],
      publishedAt: "2026-06-09",
      source: "seed",
    },
  ],
  es: [
    ...
    {
      slug: "que-comer-antes-de-entrenar",
      title: "Qué comer antes de entrenar para tener energía de verdad",
      excerpt: "La comida pre-entreno correcta evita esa sensación de cuerpo pesado o de debilidad a mitad del ejercicio.",
      body: [
        "Una comida con carbohidrato de fácil digestión 1 a 3 horas antes del entreno suele dar energía sin pesar en el estómago — cosas como un plátano, avena con fruta, o una tostada con mantequilla de cacahuete funcionan bien para la mayoría.",
        "Entrenar en ayunas total no es incorrecto para todos, pero quien siente mareo, debilidad o peor rendimiento sin comer antes probablemente se beneficia de un snack ligero, aunque sea pequeño.",
        "Comidas muy grasosas o muy ricas en fibra justo antes del entreno tienden a causar malestar digestivo durante el ejercicio — vale la pena probarlo en entrenos menos importantes antes de repetirlo en un día que importe.",
        "Al final, lo que funciona varía de persona a persona — presta atención a cómo responde tu cuerpo y ajusta el horario y la cantidad a partir de ahí, en vez de seguir una regla fija.",
      ],
      tags: ["nutrición", "pre-entreno"],
      publishedAt: "2026-06-23",
      source: "seed",
    },
    {
      slug: "como-leer-etiqueta-nutricional",
      title: "Cómo leer una etiqueta nutricional pensando en tus objetivos de entreno",
      excerpt: "La etiqueta tiene más información útil de lo que parece — solo hay que saber dónde mirar.",
      body: [
        "La tabla nutricional muestra valores por porción, no por el paquete entero — vale la pena revisar el tamaño de la porción primero, porque es fácil subestimar cuánto se está comiendo en realidad cuando el paquete tiene varias porciones.",
        "Para quien entrena regularmente, prestar atención a la proteína y la fibra ayuda tanto en la recuperación muscular como en la saciedad a lo largo del día — no todo alimento procesado deja esto claro, así que vale la pena mirar la tabla, no solo el envase.",
        "La lista de ingredientes está ordenada por cantidad, de mayor a menor — si el azúcar o algún tipo de aceite aparece en los primeros lugares, eso dice más sobre el alimento que cualquier sello de \"saludable\" en el frente del envase.",
        "Esto no tiene que convertirse en una auditoría de cada comida — usar esta mirada principalmente en los alimentos que compras con más frecuencia ya marca la diferencia con el tiempo.",
      ],
      tags: ["nutrición", "hábitos alimenticios"],
      publishedAt: "2026-06-16",
      source: "seed",
    },
    {
      slug: "snacks-proteicos-para-dia-ocupado",
      title: "Snacks prácticos y proteicos para un día ocupado",
      excerpt: "Tener una opción lista evita caer en el primer snack de la máquina cuando llega el hambre.",
      body: [
        "Huevos cocidos, yogur natural con fruta, o un puñado de frutos secos son opciones que no necesitan preparación en el momento y caben en una bolsa o en la nevera del trabajo.",
        "Combinar una fuente de proteína con una de carbohidrato — como queso con fruta, o hummus con zanahoria — suele aguantar más el hambre que cualquiera de los dos por separado.",
        "Preparar 2 o 3 porciones el fin de semana (huevos cocidos, potes de yogur con granola aparte) reduce la posibilidad de quedarte sin una buena opción durante la semana ocupada.",
        "No existe un snack perfecto universal — el mejor es el que realmente vas a preparar y comer de nuevo, así que vale la pena empezar simple antes de intentar algo demasiado elaborado para mantener en la rutina.",
      ],
      tags: ["nutrición", "practicidad"],
      publishedAt: "2026-06-09",
      source: "seed",
    },
  ],
