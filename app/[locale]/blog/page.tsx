        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {posts.map((post, i) => (
            <Link
              ...
              className="overflow-hidden rounded-2xl border border-white/10 bg-graphite transition-colors hover:border-gold/40"
            >
              ...
              <div className="p-5">
                ...
                <h2 className="mt-2 font-heading text-base font-bold leading-snug">{post.title}</h2>
                <p className="mt-2 text-sm text-silver line-clamp-3">{post.excerpt}</p>
